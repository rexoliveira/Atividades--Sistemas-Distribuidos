package com.mycompany.servidordatahora;
...
public class ChatServidorVisao extends javax.swing.JFrame {
    ...
    public class Servidor implements Runnable {
        ...
        private void entradaDados() throws IOException{
            //Para ler dados vindos do cliente 
            br= new BufferedReader(new InputStreamReader(socket.getInputStream()));
            //Para enviar dados para cliente
            ps= new PrintStream(socket.getOutputStream());
            // para ler dados do teclado
        BufferedReader kb
            = new BufferedReader(
                new InputStreamReader(System.in));
        // servidor executa continuamente
        while (true) {
  
            String str, str1;
  
            //repete enquanto o cliente não envia uma string nula
